...
const Hero = () => {
  return (
    <div className='grid grid-cols-1 justify-items-center md:justify-items-end  md:grid-cols-2  md:mx-10 lg:mr-10 lg:justify-items-start lg:pl-4'>
        <div className='mb-5 md:pt-7 lg:pt-10 '>
        ...
        <div className=' w-5/5 flex justify-center md:justify-end md:w-full lg:w-4/5 md:mr-7 '>
            <HeroImages />
        </div>
