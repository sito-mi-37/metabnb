    ...
    <div className='h-full w-full fixed z-20 top-0 bg-[rgba(64,64,64,0.3)] flex justify-center items-center transition ease-in-out duration-500'>
        <div className='bg-white  w-2/3 md:w-1/3  rounded-xl shadow-xl'>
            ...
            <div className='px-4 mb-7'>
                <h5 className='text-sm mb-1'>Choose your preferred wallet:</h5>
                <div className='border border-[#CFD8DC] bg-[#F8F9FA] flex justify-between px-2 py-2 rounded-md mb-5'>
                ...
                <div className='border flex justify-between border-[#CFD8DC] bg-[#F8F9FA] px-2 py-2 rounded-md '>
                    <div className=' flex items-center gap-2 '>
